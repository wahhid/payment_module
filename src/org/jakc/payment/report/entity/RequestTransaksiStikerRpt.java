 ...
 * @author wahhid
 */
public class RequestTransaksiStikerRpt{
    ...
    private String jenis_transaksi_name;
    private int cara_bayar;
    private String cara_bayar_name;
    ...
    public String getJenis_transaksi_name() {
        return jenis_transaksi_name;
    }

    public void setJenis_transaksi_name(String jenis_transaksi_name) {
        this.jenis_transaksi_name = jenis_transaksi_name;
    }

    public String getCara_bayar_name() {
        return cara_bayar_name;
    }

    public void setCara_bayar_name(String cara_bayar_name) {
        this.cara_bayar_name = cara_bayar_name;
    }
